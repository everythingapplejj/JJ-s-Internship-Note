import './TypeCtaBreakpointsMobileDarkModeTrue.css'

export default function TypeCtaBreakpointsMobileDarkModeTrue() {
  return (
    <div className="type-cta-breakpoints-mobile-dark-mode-true">
      <div className="bar">
