import './TypeAdvancedStateTypingDarkModeFalseSizeLarge.css'

export default function TypeAdvancedStateTypingDarkModeFalseSizeLarge() {
  return (
    <div className="type-advanced-state-typing-dark-mode-false-size-large">
      <div className="input">
