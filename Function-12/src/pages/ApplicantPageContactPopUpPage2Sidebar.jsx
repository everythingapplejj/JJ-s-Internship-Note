import './ApplicantPageContactPopUpPage2Sidebar.css'

export default function ApplicantPageContactPopUpPage2Sidebar() {
  return (
    <div className="applicant-page-contact-pop-up-page-2-sidebar">
      ...
      <div className="container-2">
        <div className="modal">
          ...
          <div className="modal-body">
            ...
            Would you like to change Applicant Name’s application status?
            </span>
          </div>
          ...
          <div className="frame-10151">
            <div className="rectangle-1730">
            </div>
            <div className="rectangle-1729">
            </div>
          </div>
        </div>
      </div>
