import './TypeDefaultStateActiveDarkModeFalseSizeLarge.css'

export default function TypeDefaultStateActiveDarkModeFalseSizeLarge() {
  return (
    <div className="type-default-state-active-dark-mode-false-size-large">
      <div className="input">
        <div className="search-outline">
          <img className="vector" src="assets/vectors/Unknown" />
        </div>
        <p className="quick-search-for-anything">
        <span className="quick-search-for-anything-sub-10"></span><span></span>
        </p>
      </div>
