import './TypeAdvancedStateWithCtaDarkModeFalseSizeLarge.css'

export default function TypeAdvancedStateWithCtaDarkModeFalseSizeLarge() {
  return (
    <div className="type-advanced-state-with-cta-dark-mode-false-size-large">
      <div className="input">
