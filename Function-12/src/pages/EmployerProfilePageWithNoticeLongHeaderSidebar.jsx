import './EmployerProfilePageWithNoticeLongHeaderSidebar.css'

export default function EmployerProfilePageWithNoticeLongHeaderSidebar() {
  return (
    <div className="employer-profile-page-with-notice-long-header-sidebar">
