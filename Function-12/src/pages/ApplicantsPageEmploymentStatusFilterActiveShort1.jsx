import './ApplicantsPageEmploymentStatusFilterActiveShort1.css'

export default function ApplicantsPageEmploymentStatusFilterActiveShort1() {
  return (
    <div className="applicants-page-employment-status-filter-active-short">
