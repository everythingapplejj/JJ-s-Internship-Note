import './TypeCtaBreakpointsMobileDarkModeFalse.css'

export default function TypeCtaBreakpointsMobileDarkModeFalse() {
  return (
    <div className="type-cta-breakpoints-mobile-dark-mode-false">
      <div className="bar">
