import './ApplicantPageWithJobDescriptionFocusSidebar.css'

export default function ApplicantPageWithJobDescriptionFocusSidebar() {
  return (
    <div className="applicant-page-with-job-description-focus-sidebar">
              ...
              <div className="modal">
                ...
                <div className="modal-body">
                  <div className="paragraph-2">
                    <p className="next-friday-should-b">
                    <span className="next-friday-should-b-sub-0"></span><span className="next-friday-should-b-sub-1"></span><span></span>
                    </p>
                  </div>
                  <div className="datepicker-1">
                    <div className="calendar-month-1">
                      <img className="vector-13" src="assets/vectors/Unknown" />
                    </div>
                    <span className="select-period-1">
                    Select period
                    </span>
                  </div>
                  <div className="paragraph-1">
                    <p className="next-friday-should-b-1">
                    <span className="next-friday-should-b-1-sub-1"></span><span></span>
                    </p>
                  </div>
                </div>
              </div>
