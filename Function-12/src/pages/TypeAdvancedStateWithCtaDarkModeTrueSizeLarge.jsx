import './TypeAdvancedStateWithCtaDarkModeTrueSizeLarge.css'

export default function TypeAdvancedStateWithCtaDarkModeTrueSizeLarge() {
  return (
    <div className="type-advanced-state-with-cta-dark-mode-true-size-large">
      <div className="input">
