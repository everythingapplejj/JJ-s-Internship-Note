import './EmployerProfilePageWithNoticeLong.css'

export default function EmployerProfilePageWithNoticeLong() {
  return (
    <div className="employer-profile-page-with-notice-long">
          ...
          <div className="body">
            ...
            <div className="forms">
              <div className="container-2">
                ...
                <div className="frame-1000004332">
