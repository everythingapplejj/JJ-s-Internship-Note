import './EmployerMyListingsReviewListingMinimized.css'

export default function EmployerMyListingsReviewListingMinimized() {
  return (
    <div className="employer-my-listings-review-listing-minimized">
