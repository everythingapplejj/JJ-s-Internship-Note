import './ApplicantsPageApplicationStatusFilterActiveShort1.css'

export default function ApplicantsPageApplicationStatusFilterActiveShort1() {
  return (
    <div className="applicants-page-application-status-filter-active-short">
