import './EmployerDeleteListing3.css'

export default function EmployerDeleteListing3() {
  return (
    <div className="employer-delete-listing">
          ...
          <div className="frame-1024">
            <div className="alerts">
              <div className="description">
                ...
                Listing Successfully Moved to the Trash
                </span>
                <div className="x">
