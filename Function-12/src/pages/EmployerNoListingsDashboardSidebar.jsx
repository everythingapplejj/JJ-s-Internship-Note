import './EmployerNoListingsDashboardSidebar.css'

export default function EmployerNoListingsDashboardSidebar() {
  return (
    <div className="employer-no-listings-dashboard-sidebar">
