import './ApplicantPageContactPopUpPage1Sidebar.css'

export default function ApplicantPageContactPopUpPage1Sidebar() {
  return (
    <div className="applicant-page-contact-pop-up-page-1-sidebar">
              ...
              <div className="modal">
                ...
                <div className="modal-footer">
                  <div className="project-description">
                    <span className="next-friday-should-b-1">
                    email@email.com<br />
                    (111) 111-1111
                    </span>
                  </div>
