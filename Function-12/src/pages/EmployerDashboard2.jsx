import './EmployerDashboard2.css'

export default function EmployerDashboard2() {
  return (
    <div className="employer-dashboard">
      ...
      <div className="container-3">
        ...
        <div className="frame-1000004335">
          ...
          <div className="frame-1000004330">
            <div className="headers">
              <span className="recently-posted-jobs">
            ...
            <div className="listing-card-web-3">
              <div className="heading-9">
                ...
                <div className="buttons-3">
                  ...
                  <div className="indicator-examples-3">
                    <div className="button-12">
                      <span className="text-32">
                      View Applicants
                      </span>
                    </div>
                    <div className="indicators-3">
            ...
            <div className="listing-card-web-4">
              <div className="heading-12">
                ...
                <div className="buttons-4">
                  ...
                  <div className="indicator-examples-4">
                    <div className="button-14">
                      <span className="text-39">
                      View Applicants
                      </span>
                    </div>
                    <div className="indicators-4">
