import './EmployerPostAjobInputInfoCustomQuestionsEnabled.css'

export default function EmployerPostAjobInputInfoCustomQuestionsEnabled() {
  return (
    <div className="employer-post-ajob-input-info-custom-questions-enabled">
