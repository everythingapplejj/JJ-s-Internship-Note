import './ApplicantPageWithSkillsFocusSidebar.css'

export default function ApplicantPageWithSkillsFocusSidebar() {
  return (
    <div className="applicant-page-with-skills-focus-sidebar">
      <div className="container-3">
        ...
        <div className="frame-1000004342">
            ...
            <div className="content">
              <div className="container-2">
                <div className="header">
                  <div className="applicant-deets">
                    ...
                    <div className="container-6">
                      <p className="applicant-name-pronouns">
                      <span className="applicant-name-pronouns-sub-0"></span><span></span>
                      </p>
                ...
                <div className="custom">
                  ...
                  <span className="relevant-experience-1-sub-0"></span><span></span>
                  </p>
                </div>
              </div>
            ...
            <div className="modal">
              ...
              <div className="modal-body">
                <div className="paragraph-1">
                  <div className="next-friday-should-b">
                  Relevant Skills:
                  </div>
                  <div className="frame-10000043241">
                    <div className="frame-10000043251">
                    ...
                    <div className="frame-10000043261">
                ...
                <div className="paragraph-2">
                  <div className="next-friday-should-b-1">
                  All Skills:
                  </div>
                  <div className="frame-10000043242">
                    <div className="frame-10000043252">
                    ...
                    <div className="frame-10000043262">
                    ...
                    <div className="frame-10000043271">
                    ...
                    <div className="frame-1000004328">
                      <div className="badge-22">
                        <span className="text-25">
                        Skill 10
                        </span>
                      </div>
                      <div className="badge-23">
          ...
          <div className="frame-1000004348">
            ...
            <div className="list-3">
              ...
              <div className="list-item-12">
                ...
                <span className="suporting-text-12">
                Logout
                </span>
              </div>
            </div>
