import './TypeAdvancedStateActiveDarkModeTrueSizeLarge.css'

export default function TypeAdvancedStateActiveDarkModeTrueSizeLarge() {
  return (
    <div className="type-advanced-state-active-dark-mode-true-size-large">
      <div className="input">
