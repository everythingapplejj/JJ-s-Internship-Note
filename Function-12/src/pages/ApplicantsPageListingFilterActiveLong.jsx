import './ApplicantsPageListingFilterActiveLong.css'

export default function ApplicantsPageListingFilterActiveLong() {
  return (
    <div className="applicants-page-listing-filter-active-long">
