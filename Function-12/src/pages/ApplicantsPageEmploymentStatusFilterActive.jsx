import './ApplicantsPageEmploymentStatusFilterActive.css'

export default function ApplicantsPageEmploymentStatusFilterActive() {
  return (
    <div className="applicants-page-employment-status-filter-active">
                ...
                <div className="heading-24">
                  <div className="main-info-4">
                    ...
                    <div className="heading-text-4">
                      ...
                      <p className="text-33">
                      <span className="text-33-sub-1"></span><span className="text-33-sub-2"></span><span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="heading-29">
                  <div className="main-info-5">
                    ...
                    <div className="heading-text-5">
                      ...
                      <p className="text-41">
                      <span className="text-41-sub-1"></span><span className="text-41-sub-2"></span><span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="heading-44">
                  <div className="main-info-8">
                    ...
                    <div className="heading-text-8">
                      ...
                      <p className="text-65">
                      <span className="text-65-sub-1"></span><span className="text-65-sub-2"></span><span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="heading-49">
                  <div className="main-info-9">
                    ...
                    <div className="heading-text-9">
                      ...
                      <p className="text-73">
                      <span className="text-73-sub-1"></span><span className="text-73-sub-2"></span><span></span>
                      </p>
                    </div>
                  </div>
