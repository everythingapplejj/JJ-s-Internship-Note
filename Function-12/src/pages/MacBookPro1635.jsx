import './MacBookPro1635.css'

export default function MacBookPro1635() {
  return (
    <div className="mac-book-pro-1635">
      <img className="line-55" src="assets/vectors/Unknown" />
        ...
        <div className="container-97">
          ...
          <div className="container-66">
            <div className="autocomplete-input">
              ...
              <div className="autocomplete-input-1">
                <div className="content-1">
                  <div className="search-outline-1">
                    <img className="vector-2" src="assets/vectors/Unknown" />
                  </div>
                  <span className="quick-search-for-anything-1">
                  What part-time job are you seeking?
                  </span>
                </div>
                <div className="card-6">
                  <div className="ellipse-878">
                  </div>
                  <div className="ellipse-879">
                  </div>
                  <div className="line-73">
                  </div>
                  <div className="line-74">
                  </div>
                  <div className="line-75">
                  </div>
                  <div className="line-76">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="container-140">
                <div className="container-21">
                  <div className="group-994">
                    <span className="area-address">
                    Area   Address
                    </span>
                    <div className="ellipse-817">
                    </div>
                  </div>
                  <span className="hr">
                  $$$/Hr
            ...
            <div className="card-3">
              ...
              <div className="container-35">
                <div className="container-16">
                  <div className="group-995">
                    <span className="area-address-1">
                    Area   Address
                    </span>
                    <div className="ellipse-8171">
                    </div>
                  </div>
                  <span className="hr-1">
                  $$$/Hr
              ...
              <div className="container-91">
                ...
                <div className="ellipse-699">
                </div>
                <div className="ellipse-705">
                </div>
              </div>
            </div>
            <div className="line-65">
            </div>
          </div>
            ...
            <div className="card-5">
              <div className="container-73">
                <div className="container-4">
                  <div className="ellipse-858">
                  </div>
                  <div className="container-75">
                    <div className="company-name-2">
                    Company Name
                    </div>
                    <span className="job-title-2">
                    Job Title
                    </span>
                  </div>
                </div>
                <div className="recency-2">
                Recency
                </div>
              </div>
              <div className="container-80">
                <div className="container-67">
                  <div className="group-1000">
                    <span className="area-address-3">
                    Area   Address
                    </span>
                    <div className="ellipse-8173">
                    </div>
                  </div>
                  <span className="hr-3">
                  $$$/Hr
        ...
        <div className="container-120">
            ...
            <div className="card-1">
              <div className="container-46">
                <div className="container-44">
                  <div className="ellipse-834">
                  </div>
                  <div className="container-90">
                    <div className="company-name-5">
                    Company Name
                    </div>
                    <span className="job-title-5">
                    Job Title
                    </span>
                  </div>
                </div>
                <div className="recency-5">
                Recency
                </div>
              </div>
              <div className="container-42">
                <div className="container-6">
                  <div className="group-997">
                    <span className="area-address-6">
                    Area   Address
                    </span>
                    <div className="ellipse-8176">
                    </div>
                  </div>
                  <span className="hr-6">
                  $$$/Hr
              ...
              <div className="container-49">
                ...
                <div className="ellipse-827">
                </div>
                <div className="ellipse-833">
                </div>
              </div>
            </div>
            <div className="line-67">
            </div>
          </div>
          <div className="container-32">
              ...
              <div className="card-2">
                <div className="container-143">
                  <div className="container-133">
                    <div className="ellipse-826">
                    </div>
                    <div className="container-111">
                      <div className="company-name-1">
                      Company Name
                      </div>
                      <span className="job-title-1">
                      Job Title
                      </span>
                    </div>
                  </div>
                  <div className="recency-1">
                  Recency
                  </div>
                </div>
                <div className="container-116">
                  <div className="container-7">
                    <div className="group-996">
                      <span className="area-address-2">
                      Area   Address
                      </span>
                      <div className="ellipse-8172">
                      </div>
                    </div>
                    <span className="hr-2">
                    $$$/Hr
                ...
                <div className="container-65">
                  ...
                  <div className="ellipse-819">
                  </div>
                  <div className="ellipse-825">
                  </div>
                </div>
              </div>
              <div className="line-66">
              </div>
            </div>
            <div className="pagination">
              ...
              <div className="page-item-3">
                <span className="text-29">
                3
                </span>
              </div>
              <div className="page-item-4">
            ...
            <div className="card-4">
              <div className="container-14">
                <div className="container-63">
                  <div className="ellipse-866">
                  </div>
                  <div className="container-112">
                    <div className="company-name-3">
                    Company Name
                    </div>
                    <span className="job-title-3">
                    Job Title
                    </span>
                  </div>
                </div>
                <div className="recency-3">
                Recency
                </div>
              </div>
              <div className="container-29">
                <div className="container-1">
                  <div className="group-1001">
                    <span className="area-address-4">
                    Area   Address
                    </span>
                    <div className="ellipse-8174">
                    </div>
                  </div>
                  <span className="hr-4">
                  $$$/Hr
              ...
              <div className="container-102">
                ...
                <div className="ellipse-859">
                </div>
                <div className="ellipse-865">
                </div>
              </div>
            </div>
              ...
              <div className="container-82">
                <div className="container-141">
                  ...
                  <div className="container-18">
                    ...
                    <span className="job-title-7">
                    Job Title
                    </span>
                  </div>
                </div>
                <div className="recency-7">
                Recency
                </div>
              </div>
              <div className="group-999">
                <span className="area-address-8">
                Area   Address
                </span>
                <div className="ellipse-8178">
                </div>
              </div>
              <div className="hr-8">
              $$$/Hr
          ...
          <div className="container-45">
            <div className="card-9">
              <div className="container-34">
                <div className="container-11">
                  ...
                  <div className="container-69">
                    ...
                    <span className="job-title-6">
                    Job Title
                    </span>
                  </div>
                </div>
                <div className="recency-6">
                Recency
                </div>
              </div>
              <div className="group-998">
                <span className="area-address-7">
                Area   Address
                </span>
                <div className="ellipse-8177">
                </div>
              </div>
              <div className="hr-7">
              $$$/Hr
              ...
              <div className="container-78">
                ...
                <div className="ellipse-835">
                </div>
                <div className="ellipse-841">
                </div>
              </div>
            </div>
            <div className="line-68">
            </div>
          </div>
            ...
            <div className="card-7">
              <div className="container-119">
                <div className="container-93">
                  <div className="ellipse-874">
                  </div>
                  <div className="container-87">
                    <div className="company-name-4">
                    Company Name
                    </div>
                    <span className="job-title-4">
                    Job Title
                    </span>
                  </div>
                </div>
                <div className="recency-4">
                Recency
                </div>
              </div>
              <div className="container-37">
                <div className="container-55">
                  <div className="group-1002">
                    <span className="area-address-5">
                    Area   Address
                    </span>
                    <div className="ellipse-8175">
                    </div>
                  </div>
                  <span className="hr-5">
                  $$$/Hr
              ...
              <div className="container-131">
                ...
                <div className="ellipse-867">
                </div>
                <div className="ellipse-873">
                </div>
              </div>
            </div>
