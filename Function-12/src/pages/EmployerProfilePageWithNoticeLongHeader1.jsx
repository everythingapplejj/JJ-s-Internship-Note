import './EmployerProfilePageWithNoticeLongHeader1.css'

export default function EmployerProfilePageWithNoticeLongHeader1() {
  return (
    <div className="employer-profile-page-with-notice-long-header">
      <div className="container-3">
        ...
        <div className="container-1">
          ...
          <div className="frame-1000004333">
