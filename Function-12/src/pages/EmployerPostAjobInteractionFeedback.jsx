import './EmployerPostAjobInteractionFeedback.css'

export default function EmployerPostAjobInteractionFeedback() {
  return (
    <div className="employer-post-ajob-interaction-feedback">
      <div className="container-2">
        ...
        <div className="container-19">
          ...
          <div className="container-5">
            <span className="add-the-title-you-are-hiring-for">
            Add the title you are hiring for
            </span>
          </div>
