import './TypeAdvancedStateActiveDarkModeFalseSizeLarge.css'

export default function TypeAdvancedStateActiveDarkModeFalseSizeLarge() {
  return (
    <div className="type-advanced-state-active-dark-mode-false-size-large">
      <div className="input">
        <div className="search-outline">
          <img className="vector" src="assets/vectors/Unknown" />
        </div>
        <p className="quick-search-for-anything">
        <span className="quick-search-for-anything-sub-8"></span><span></span>
        </p>
      </div>
