...
export default function EmployerDashboardV2() {
  return (
    <div className="employer-dashboard-v-2">
        ...
        <div className="container-14">
          <div className="container-31">
            ...
            <div className="container-46">
              ...
              <div className="material-symbolsadd">
          ...
          <div className="container-28">
            <div className="container-23">
              <div className="material-symbolswork">
            ...
            <div className="container-9">
              <div className="icbaseline-people-1">
            ...
            <div className="container-39">
              <img className="claritynew-line" src="assets/vectors/Unknown" />
              <span className="container-3">
              50
              </span>
              <span className="new-applicants">
              New Applicants
              </span>
            </div>
            <div className="container-25">
              <div className="icon-park-outlineeyes">
              ...
              <div className="container-19">
                <div className="container-22">
                  ...
                  <div className="container-3">
                    <span className="michael-scott">
                    Michael Scott
                    </span>
                    <p className="for-social-media-strategist">
                    <span className="for-social-media-strategist-sub-0"></span><span></span>
                    </p>
                    <span className="michael-scott-1">
                    Michael Scott
                    </span>
                    <p className="for-social-media-strategist-1">
                    <span className="for-social-media-strategist-1-sub-0"></span><span></span>
                    </p>
                  </div>
                  <div className="container-5">
                    <div className="at-915-pst">
                    at 9:15 PST
                    </div>
                    <span className="at-915-pst-1">
                    at 9:15 PST
                    </span>
                  </div>
                </div>
                <div className="container-24">
                  <div className="container-27">
                    <div className="group-346">
                      ...
                      <div className="icbaseline-message">
                    ...
                    <div className="group-348">
                      ...
                      <div className="icbaseline-message-1">
                  ...
                  <div className="container-32">
                    <div className="group-345">
                      ...
                      <div className="material-symbolscheck">
                        <img className="vector-25" src="assets/vectors/Unknown" />
                      </div>
                    </div>
                    <div className="group-349">
                      <span className="hire-1">
                      Hire
                      </span>
                      <div className="material-symbolscheck-1">
                        <img className="vector-26" src="assets/vectors/Unknown" />
                      </div>
                    </div>
                  </div>
                  <div className="container">
                    <div className="group-347">
                      <span className="cancel-interview">
                      Cancel Interview
                      </span>
                      <div className="material-symbolscancel-outline">
                        <img className="vector-29" src="assets/vectors/Unknown" />
                      </div>
                    </div>
                    <div className="group-350">
                      <span className="cancel-interview-1">
                      Cancel Interview
                      </span>
                      <div className="material-symbolscancel-outline-1">
                        <img className="vector-30" src="assets/vectors/Unknown" />
                      </div>
                    </div>
                  </div>
              ...
              <div className="container-43">
                <div className="container-11">
                  ...
                  <div className="container-10">
                    <span className="michael-scott-2">
                    Michael Scott
                    </span>
                    <p className="for-social-media-strategist-2">
                    <span className="for-social-media-strategist-2-sub-0"></span><span></span>
                    </p>
                  </div>
                </div>
                <div className="at-915-pst-2">
                at 9:15 PST
                </div>
                <div className="container-51">
                  <div className="group-351">
                    ...
                    <div className="icbaseline-message-2">
                      <img className="vector-23" src="assets/vectors/Unknown" />
                    </div>
                  </div>
                  <div className="group-352">
                    <span className="hire-2">
                    Hire
                    </span>
                    <div className="material-symbolscheck-2">
                      <img className="vector-27" src="assets/vectors/Unknown" />
                    </div>
                  </div>
                  <div className="group-353">
                    <span className="cancel-interview-2">
                    Cancel Interview
                    </span>
                    <div className="material-symbolscancel-outline-2">
                      <img className="vector-31" src="assets/vectors/Unknown" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="container-12">
                <div className="container-6">
                  ...
                  <div className="container-48">
                    <span className="michael-scott-3">
                    Michael Scott
                    </span>
                    <p className="for-social-media-strategist-3">
                    <span className="for-social-media-strategist-3-sub-0"></span><span></span>
                    </p>
                  </div>
                </div>
                <div className="at-915-pst-3">
                at 9:15 PST
                </div>
                <div className="container-45">
                  <div className="group-354">
                    <span className="message-3">
                    Message
                    </span>
                    <div className="icbaseline-message-3">
                      <img className="vector-24" src="assets/vectors/Unknown" />
                    </div>
                  </div>
                  <div className="group-355">
                    <span className="hire-3">
                    Hire
                    </span>
                    <div className="material-symbolscheck-3">
                      <img className="vector-28" src="assets/vectors/Unknown" />
                    </div>
                  </div>
                  <div className="group-356">
                    <span className="cancel-interview-3">
                    Cancel Interview
                    </span>
                    <div className="material-symbolscancel-outline-3">
                      <img className="vector-32" src="assets/vectors/Unknown" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="container-33">
            <div className="container-35">
              <div className="container-49">
                <div className="social-media-strategist">
                Social Media Strategist
                </div>
                <span className="remote-usa">
                Remote, USA
                </span>
              </div>
              <div className="group-334">
                <span className="view-applicants">
                View Applicants
                </span>
              </div>
            </div>
            <div className="container-36">
              <div className="created-on-december-142023">
              created on: December 14, 2023
              </div>
              <div className="group-335">
                <span className="manage-listing">
                Manage Listing
                </span>
              </div>
            </div>
