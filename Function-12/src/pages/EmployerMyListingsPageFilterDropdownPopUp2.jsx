import './EmployerMyListingsPageFilterDropdownPopUp2.css'

export default function EmployerMyListingsPageFilterDropdownPopUp2() {
  return (
    <div className="employer-my-listings-page-filter-dropdown-pop-up">
        ...
        <div className="body">
          <div className="container-1">
                ...
                <div className="container-7">
                  ...
                  <div className="nav-links">
                    <div className="search">
                      ...
                      <span className="search-mockups-logos">
            ...
            <div className="listings">
              <div className="listing-card-web">
                  ...
                  <div className="text-info">
                    <div className="frame-1030">
                      ...
                      <div className="frame-1000004317">
                        ...
                        Seeking a barista proficient in coffee making, pastry handling, and register operations for our café. Fast-paced environment. Strong customer service skills required.
                        </span>
                      </div>
                    </div>
              ...
              <div className="listing-card-web-1">
              ...
              <div className="listing-card-web-2">
                <div className="heading-6">
                  ...
                  <div className="buttons-2">
                    ...
                    <div className="indicator-examples-1">
                      <div className="button-8">
                        <span className="text-24">
                        View Applicants
                        </span>
                      </div>
                      <div className="indicators-1">
              ...
              <div className="listing-card-web-3">
              ...
              <div className="listing-card-web-4">
                <div className="heading-12">
                  ...
                  <div className="buttons-4">
                    ...
                    <div className="indicator-examples-2">
