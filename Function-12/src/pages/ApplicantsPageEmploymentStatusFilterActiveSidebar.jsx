import './ApplicantsPageEmploymentStatusFilterActiveSidebar.css'

export default function ApplicantsPageEmploymentStatusFilterActiveSidebar() {
  return (
    <div className="applicants-page-employment-status-filter-active-sidebar">
      ...
      <div className="container-10">
        ...
        <div className="frame-1000004339">
