import './EmployerProfilePageWithNoticeSidebar.css'

export default function EmployerProfilePageWithNoticeSidebar() {
  return (
    <div className="employer-profile-page-with-notice-sidebar">
