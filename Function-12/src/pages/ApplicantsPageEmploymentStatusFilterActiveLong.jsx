import './ApplicantsPageEmploymentStatusFilterActiveLong.css'

export default function ApplicantsPageEmploymentStatusFilterActiveLong() {
  return (
    <div className="applicants-page-employment-status-filter-active-long">
