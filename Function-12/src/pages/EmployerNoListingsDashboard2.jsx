import './EmployerNoListingsDashboard2.css'

export default function EmployerNoListingsDashboard2() {
  return (
    <div className="employer-no-listings-dashboard">
            ...
            <div className="frame-1024">
              <div className="alerts">
                <div className="description">
                  ...
                  To see a summary of active listings, post a new listing.
                  </span>
                </div>
