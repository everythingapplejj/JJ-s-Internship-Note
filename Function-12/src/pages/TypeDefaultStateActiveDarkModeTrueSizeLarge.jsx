import './TypeDefaultStateActiveDarkModeTrueSizeLarge.css'

export default function TypeDefaultStateActiveDarkModeTrueSizeLarge() {
  return (
    <div className="type-default-state-active-dark-mode-true-size-large">
      <div className="input">
