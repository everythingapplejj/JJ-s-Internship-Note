import './EmployerCloseListing.css'

export default function EmployerCloseListing() {
  return (
    <div className="employer-close-listing">
      ...
      <div className="container-2">
        ...
        <div className="frame-1000004335">
          ...
          <div className="frame-1024">
            ...
            Listing Successfully Closed to Applicants
            </span>
