import './TypeCtaBreakpointsDesktopDarkModeFalse.css'

export default function TypeCtaBreakpointsDesktopDarkModeFalse() {
  return (
    <div className="type-cta-breakpoints-desktop-dark-mode-false">
      <div className="bar">
