import './EmployerMyListingsPageFilterDropdownPopUp.css'

export default function EmployerMyListingsPageFilterDropdownPopUp() {
  return (
                ...
                <div className="container-1">
                  ...
                  <div className="nav-links">
                    <div className="search">
                      ...
                      <span className="search-for-alisting">
            ...
            <div className="listings">
              ...
              <div className="listing-card-web-3">
                ...
                <div className="text-info-3">
                  <div className="listing-description-1">
