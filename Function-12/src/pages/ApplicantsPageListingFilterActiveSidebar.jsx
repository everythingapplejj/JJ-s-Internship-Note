import './ApplicantsPageListingFilterActiveSidebar.css'

export default function ApplicantsPageListingFilterActiveSidebar() {
  return (
    <div className="applicants-page-listing-filter-active-sidebar">
      ...
      <div className="container-11">
        ...
        <div className="frame-1000004338">
          <div className="navbar">
            ...
            <div className="dropdown-menu">
              ...
              <div className="dropdown-menu-item-1">
                <span className="text-2">
                Listing 2
                </span>
              </div>
              <div className="dropdown-menu-item-2">
                <span className="text-3">
                Listing 3
                </span>
              </div>
              <div className="dropdown-menu-item-3">
                <span className="text-4">
                Listing 4
                </span>
              </div>
              <div className="dropdown-menu-item-4">
                <span className="text-5">
                Listing 5
                </span>
              </div>
              <div className="dropdown-menu-item-5">
              ...
              <div className="heading-4">
                <div className="main-info">
                  ...
                  <div className="heading-text">
                    ...
                    <p className="text-7">
                    <span className="text-7-sub-1"></span><span></span>
                    </p>
                  </div>
                </div>
                ...
                <div className="text-info">
                  <div className="application-status">
                    ...
                    <div className="frame-1000004317">
                      <p className="text-9">
                      <span className="text-9-sub-5"></span><span></span>
                      </p>
              ...
              <div className="heading-9">
                <div className="main-info-1">
                  ...
                  <div className="heading-text-1">
                    ...
                    <p className="text-15">
                    <span className="text-15-sub-1"></span><span></span>
                    </p>
                  </div>
                </div>
                ...
                <div className="text-info-1">
                  <div className="application-status-1">
                    ...
                    <div className="frame-10000043171">
                      <p className="text-17">
                      <span className="text-17-sub-5"></span><span></span>
                      </p>
              ...
              <div className="heading-14">
                <div className="main-info-2">
                  ...
                  <div className="heading-text-2">
                    ...
                    <p className="text-23">
                    <span className="text-23-sub-1"></span><span></span>
                    </p>
                  </div>
                </div>
                ...
                <div className="text-info-2">
                  <div className="application-status-2">
                    ...
                    <div className="frame-10000043172">
                      <p className="text-25">
                      <span className="text-25-sub-5"></span><span></span>
                      </p>
                      <span className="text-27">
                      Reviewed
                      </span>
                    </div>
                  </div>
              ...
              <div className="heading-19">
                <div className="main-info-3">
                  ...
                  <div className="heading-text-3">
                    ...
                    <p className="text-31">
                    <span className="text-31-sub-1"></span><span></span>
                    </p>
                  </div>
                </div>
                ...
                <div className="text-info-3">
                  <div className="application-status-3">
                    ...
                    <div className="frame-10000043173">
                      <p className="text-33">
                      <span className="text-33-sub-5"></span><span></span>
                      </p>
              ...
              <div className="heading-24">
                <div className="main-info-4">
                  ...
                  <div className="heading-text-4">
                    ...
                    <p className="text-39">
                    <span className="text-39-sub-1"></span><span></span>
                    </p>
                  </div>
                </div>
                ...
                <div className="text-info-4">
                  <div className="application-status-4">
                    ...
                    <div className="frame-10000043174">
                      <p className="text-41">
                      <span className="text-41-sub-5"></span><span></span>
                      </p>
              ...
              <div className="heading-29">
                <div className="main-info-5">
                  ...
                  <div className="heading-text-5">
                    ...
                    <p className="text-47">
                    <span className="text-47-sub-1"></span><span></span>
                    </p>
                  </div>
                </div>
                ...
                <div className="text-info-5">
                  <div className="application-status-5">
                    ...
                    <div className="frame-10000043175">
                      <p className="text-49">
                      <span className="text-49-sub-5"></span><span></span>
                      </p>
              ...
              <div className="heading-34">
                <div className="main-info-6">
                  ...
                  <div className="heading-text-6">
                    ...
                    <p className="text-55">
                    <span className="text-55-sub-1"></span><span></span>
                    </p>
                  </div>
                </div>
                ...
                <div className="text-info-6">
                  <div className="application-status-6">
                    ...
                    <div className="frame-10000043176">
                      <p className="text-57">
                      <span className="text-57-sub-5"></span><span></span>
                      </p>
                      <span className="text-59">
                      Reviewed
                      </span>
                    </div>
                  </div>
              ...
              <div className="heading-39">
                <div className="main-info-7">
                  ...
                  <div className="heading-text-7">
                    ...
                    <p className="text-63">
                    <span className="text-63-sub-1"></span><span></span>
                    </p>
                  </div>
                </div>
                ...
                <div className="text-info-7">
                  <div className="application-status-7">
                    ...
                    <div className="frame-10000043177">
                      <p className="text-65">
                      <span className="text-65-sub-5"></span><span></span>
                      </p>
              ...
              <div className="heading-44">
                <div className="main-info-8">
                  ...
                  <div className="heading-text-8">
                    ...
                    <p className="text-71">
                    <span className="text-71-sub-1"></span><span></span>
                    </p>
                  </div>
                </div>
                ...
                <div className="text-info-8">
                  <div className="application-status-8">
                    ...
                    <div className="frame-10000043178">
                      <p className="text-73">
                      <span className="text-73-sub-5"></span><span></span>
                      </p>
              ...
              <div className="heading-49">
                <div className="main-info-9">
                  ...
                  <div className="heading-text-9">
                    ...
                    <p className="text-79">
                    <span className="text-79-sub-1"></span><span></span>
                    </p>
                  </div>
                </div>
                ...
                <div className="text-info-9">
                  <div className="application-status-9">
                    ...
                    <div className="frame-10000043179">
                      <p className="text-81">
                      <span className="text-81-sub-5"></span><span></span>
                      </p>
