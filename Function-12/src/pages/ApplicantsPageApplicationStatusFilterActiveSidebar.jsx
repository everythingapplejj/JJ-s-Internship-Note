import './ApplicantsPageApplicationStatusFilterActiveSidebar.css'

export default function ApplicantsPageApplicationStatusFilterActiveSidebar() {
  return (
    <div className="applicants-page-application-status-filter-active-sidebar">
                ...
                <div className="list-2">
                  ...
                  <div className="list-item-6">
                    <div className="arrow-right-to-bracket">
                      <img className="vector-23" src="assets/vectors/Unknown" />
                    </div>
