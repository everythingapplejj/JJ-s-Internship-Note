import './EmployerProfilePageWithNoticeShort.css'

export default function EmployerProfilePageWithNoticeShort() {
  return (
    <div className="employer-profile-page-with-notice-short">
              ...
              <div className="container-3">
                ...
                <div className="textfield-1">
                  ...
                  <div className="input-5">
                    <span className="this-is-placeholder-2">
                    Given Address
                    </span>
                  </div>
                </div>
                <div className="textarea">
                  ...
                  <div className="input">
                    <span className="write-text-here">
                    Write text here ...
                    </span>
                  </div>
                </div>
                <div className="checkbox">
                  ...
                  <div className="label-helper-text">
                    <div className="write-label-text-here">
                    Offer Sponsorship for non-citizens
                    </div>
                    <span className="some-helper-text-here">
                    This entails supporting an employee from another country 
                    </span>
                  </div>
                </div>
                ...
                <div className="textfield-2">
                  ...
                  <div className="input-6">
                    <span className="this-is-placeholder-3">
                    Employee Number Estimate
                    </span>
                  </div>
                </div>
                <div className="textfield-3">
                  ...
                  <div className="input-7">
                    <span className="this-is-placeholder-4">
                    Company Age Estimate
                    </span>
                  </div>
                </div>
      ...
      <div className="alerts">
        ...
        Listings cannot be uploaded until the company profile is complete.
        </span>
      </div>
    </div>
  )
