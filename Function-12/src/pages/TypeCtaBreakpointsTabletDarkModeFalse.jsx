import './TypeCtaBreakpointsTabletDarkModeFalse.css'

export default function TypeCtaBreakpointsTabletDarkModeFalse() {
  return (
    <div className="type-cta-breakpoints-tablet-dark-mode-false">
      <div className="bar">
