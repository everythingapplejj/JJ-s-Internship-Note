import './TypeAdvancedStateTypingDarkModeTrueSizeDefault.css'

export default function TypeAdvancedStateTypingDarkModeTrueSizeDefault() {
  return (
    <div className="type-advanced-state-typing-dark-mode-true-size-default">
      <div className="input">
