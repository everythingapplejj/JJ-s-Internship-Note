import './TypeDefaultStateActiveDarkModeFalseSizeDefault.css'

export default function TypeDefaultStateActiveDarkModeFalseSizeDefault() {
  return (
    <div className="type-default-state-active-dark-mode-false-size-default">
      <div className="input">
        <div className="search-outline">
          <img className="vector" src="assets/vectors/Unknown" />
        </div>
        <p className="quick-search-for-anything">
        <span className="quick-search-for-anything-sub-9"></span><span></span>
        </p>
      </div>
