import './EmployerProfilePageLongHeaderSidebar.css'

export default function EmployerProfilePageLongHeaderSidebar() {
  return (
    <div className="employer-profile-page-long-header-sidebar">
