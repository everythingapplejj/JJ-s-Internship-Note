import './DiffVersion115.css'

export default function DiffVersion115() {
  return (
    <div className="diff-version-11">
      <img className="container-120" src="assets/vectors/Unknown" />
        ...
        <div className="container-232">
          ...
          <div className="container-40">
            ...
            <div className="container-121">
              ...
              <img className="container-197" src="assets/vectors/Unknown" />
            </div>
          </div>
