import './ApplicantsPageListingFilterActiveShort1.css'

export default function ApplicantsPageListingFilterActiveShort1() {
  return (
    <div className="applicants-page-listing-filter-active-short">
