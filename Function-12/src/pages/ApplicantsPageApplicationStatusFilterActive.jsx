import './ApplicantsPageApplicationStatusFilterActive.css'

export default function ApplicantsPageApplicationStatusFilterActive() {
  return (
    <div className="applicants-page-application-status-filter-active">
      ...
      <div className="container-7">
        <div className="sidebar">
          <div className="sidebar-free-component">
            <div className="job-ez-word-mark">
              <span className="job-ez">
              JobEZ
              </span>
            </div>
              ...
              <div className="frame-1000004347">
                <div className="list-1">
                  ...
                  <div className="list-item-1">
                    <img className="vector-17" src="assets/vectors/Unknown" />
                  </div>
                  <div className="list-item-2">
                    <img className="vector-18" src="assets/vectors/Unknown" />
                  </div>
                </div>
              </div>
              <div className="frame-1000004348">
                <div className="list-2">
                  <div className="list-item-3">
                    <img className="vector-19" src="assets/vectors/Unknown" />
                  </div>
                  <div className="list-item-4">
                    <img className="vector-20" src="assets/vectors/Unknown" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="frame-1000004337">
          <div className="container">
            <div className="nav-filter">
              <div className="navbar">
                <div className="container-14">
                  <div className="logo">
                    <span className="applicants-1">
                    Applicants
                    </span>
                  </div>
              ...
              <div className="button">
                <span className="text-82">
                Download All Resumes 
                </span>
              </div>
            </div>
            <div className="applicants">
              <div className="applicant-card-web">
                <div className="heading-4">
                  <div className="main-info">
                    ...
                    <div className="heading-text">
                      ...
                      <p className="text-1">
                      <span className="text-1-sub-1"></span><span></span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="text-info">
                    <div className="application-status">
                      ...
                      <div className="frame-1000004317">
                        <p className="text-3">
                        <span className="text-3-sub-5"></span><span></span>
                        </p>
              ...
              <div className="applicant-card-web-1">
                <div className="heading-9">
                  <div className="main-info-1">
                    ...
                    <div className="heading-text-1">
                      ...
                      <p className="text-9">
                      <span className="text-9-sub-1"></span><span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="container-1">
                  ...
                  <div className="text-info-1">
                    <div className="application-status-1">
                      ...
                      <div className="frame-10000043171">
                        <p className="text-11">
                        <span className="text-11-sub-5"></span><span></span>
                        </p>
                    ...
                    <div className="recent-experience-1">
                      <div className="heading-8">
                      Recent Experience
                      </div>
                      <div className="frame-10000043182">
                    ...
                    <div className="languages-spoken-1">
                      <div className="heading-7">
                      Language Spoken
                      </div>
                      <div className="frame-10000043183">
              ...
              <div className="applicant-card-web-2">
                <div className="heading-14">
                  <div className="main-info-2">
                    ...
                    <div className="heading-text-2">
                      ...
                      <p className="text-17">
                      <span className="text-17-sub-1"></span><span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="container-10">
                  ...
                  <div className="text-info-2">
                    <div className="application-status-2">
                      ...
                      <div className="frame-10000043172">
                        <p className="text-19">
                        <span className="text-19-sub-5"></span><span></span>
                        </p>
                    ...
                    <div className="recent-experience-2">
                      <div className="heading-13">
                      Recent Experience
                      </div>
                      <div className="frame-10000043184">
                    ...
                    <div className="languages-spoken-2">
                      <div className="heading-12">
                      Language Spoken
                      </div>
                      <div className="frame-10000043185">
              ...
              <div className="applicant-card-web-3">
                <div className="heading-19">
                  <div className="main-info-3">
                    <div className="avatar-3">
                    </div>
                    <div className="heading-text-3">
                      <div className="heading-15">
                      Applicant Name
                      </div>
                      <p className="text-25">
                      <span className="text-25-sub-1"></span><span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="container-3">
                  ...
                  <div className="text-info-3">
                    <div className="application-status-3">
                      <div className="heading-16">
                      Application Status
                      </div>
                      <div className="frame-10000043173">
                        <p className="text-27">
                        <span className="text-27-sub-5"></span><span></span>
                        </p>
                    ...
                    <div className="recent-experience-3">
                      <div className="heading-18">
                      Recent Experience
                      </div>
                      <div className="frame-10000043186">
                    ...
                    <div className="languages-spoken-3">
                      <div className="heading-17">
                      Language Spoken
                      </div>
                      <div className="frame-10000043187">
              ...
              <div className="applicant-card-web-4">
                <div className="heading-24">
                  <div className="main-info-4">
                    <div className="avatar-4">
                    </div>
                    <div className="heading-text-4">
                      <div className="heading-20">
                      Applicant Name
                      </div>
                      <p className="text-33">
                      <span className="text-33-sub-1"></span><span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="container-9">
                  <div className="checkbox-8">
                    <div className="checkbox-9">
                    </div>
                  </div>
                  <div className="text-info-4">
                    <div className="application-status-4">
                      <div className="heading-21">
                      Application Status
                      </div>
                      <div className="frame-10000043174">
                        <p className="text-35">
                        <span className="text-35-sub-5"></span><span></span>
                        </p>
                        <span className="text-37">
                        Reviewed
                        </span>
                      </div>
                    </div>
                    <div className="recent-experience-4">
                      <div className="heading-23">
                      Recent Experience
                      </div>
                      <div className="frame-10000043188">
                    ...
                    <div className="languages-spoken-4">
                      <div className="heading-22">
                      Language Spoken
                      </div>
                      <div className="frame-10000043189">
                        <span className="text-39">
                        Primary: English
                        </span>
              ...
              <div className="applicant-card-web-5">
                <div className="heading-29">
                  <div className="main-info-5">
                    <div className="avatar-5">
                    </div>
                    <div className="heading-text-5">
                      <div className="heading-25">
                      Applicant Name
                      </div>
                      <p className="text-41">
                      <span className="text-41-sub-1"></span><span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="container-2">
                  ...
                  <div className="text-info-5">
                    <div className="application-status-5">
                      <div className="heading-26">
                      Application Status
                      </div>
                      <div className="frame-10000043175">
                        <p className="text-43">
                        <span className="text-43-sub-5"></span><span></span>
                        </p>
                        <span className="text-45">
                        Reviewed
                        </span>
                      </div>
                    </div>
                    <div className="recent-experience-5">
                      <div className="heading-28">
                      Recent Experience
                      </div>
                      <div className="frame-100000431810">
                        <span className="text-44">
                        Job title
                        </span>
                        <span className="text-46">
                        8/2017-Present
                        </span>
                      </div>
                    </div>
                    <div className="languages-spoken-5">
                      <div className="heading-27">
                      Language Spoken
                      </div>
                      <div className="frame-100000431811">
                        <span className="text-47">
                        Primary: English
                        </span>
              ...
              <div className="applicant-card-web-6">
                <div className="heading-34">
                  <div className="main-info-6">
                    ...
                    <div className="heading-text-6">
                      ...
                      <p className="text-49">
                      <span className="text-49-sub-1"></span><span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="container-11">
                  <div className="checkbox-12">
                    <div className="checkbox-13">
                    </div>
                  </div>
                  <div className="text-info-6">
                    <div className="application-status-6">
                      <div className="heading-31">
                      Application Status
                      </div>
                      <div className="frame-10000043176">
                        <p className="text-51">
                        <span className="text-51-sub-5"></span><span></span>
                        </p>
                        <span className="text-53">
                        Reviewed
                        </span>
                      </div>
                    </div>
                    <div className="recent-experience-6">
                      <div className="heading-33">
                      Recent Experience
                      </div>
                      <div className="frame-100000431812">
                        <span className="text-52">
                        Job title
                        </span>
                        <span className="text-54">
                        8/2017-Present
                        </span>
                      </div>
                    </div>
                    <div className="languages-spoken-6">
                      <div className="heading-32">
                      Language Spoken
                      </div>
                      <div className="frame-100000431813">
                        <span className="text-55">
                        Primary: English
                        </span>
              ...
              <div className="applicant-card-web-7">
                <div className="heading-39">
                  <div className="main-info-7">
                    <div className="avatar-7">
                    </div>
                    <div className="heading-text-7">
                      <div className="heading-35">
                      Applicant Name
                      </div>
                      <p className="text-57">
                      <span className="text-57-sub-1"></span><span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="container-6">
                  <div className="checkbox-14">
                    <div className="checkbox-15">
                    </div>
                  </div>
                  <div className="text-info-7">
                    <div className="application-status-7">
                      <div className="heading-36">
                      Application Status
                      </div>
                      <div className="frame-10000043177">
                        <p className="text-59">
                        <span className="text-59-sub-5"></span><span></span>
                        </p>
                        <span className="text-61">
                        Reviewed
                        </span>
                      </div>
                    </div>
                    <div className="recent-experience-7">
                      <div className="heading-38">
                      Recent Experience
                      </div>
                      <div className="frame-100000431814">
                        <span className="text-60">
                        Job title
                        </span>
                        <span className="text-62">
                        8/2017-Present
                        </span>
                      </div>
                    </div>
                    <div className="languages-spoken-7">
                      <div className="heading-37">
                      Language Spoken
                      </div>
                      <div className="frame-100000431815">
                        <span className="text-63">
                        Primary: English
                        </span>
              ...
              <div className="applicant-card-web-8">
                <div className="heading-44">
                  <div className="main-info-8">
                    <div className="avatar-8">
                    </div>
                    <div className="heading-text-8">
                      <div className="heading-40">
                      Applicant Name
                      </div>
                      <p className="text-65">
                      <span className="text-65-sub-1"></span><span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="container-5">
                  <div className="checkbox-16">
                    <div className="checkbox-17">
                    </div>
                  </div>
                  <div className="text-info-8">
                    <div className="application-status-8">
                      <div className="heading-41">
                      Application Status
                      </div>
                      <div className="frame-10000043178">
                        <p className="text-67">
                        <span className="text-67-sub-5"></span><span></span>
                        </p>
                    ...
                    <div className="recent-experience-8">
                      <div className="heading-43">
                      Recent Experience
                      </div>
                      <div className="frame-100000431816">
                    ...
                    <div className="languages-spoken-8">
                      <div className="heading-42">
                      Language Spoken
                      </div>
                      <div className="frame-100000431817">
                        <span className="text-71">
                        Primary: English
                        </span>
                        <span className="text-72">
                        Secondaries: Spanish
                        </span>
                      </div>
                    </div>
              ...
              <div className="applicant-card-web-9">
                <div className="heading-49">
                  <div className="main-info-9">
                    <div className="avatar-9">
                    </div>
                    <div className="heading-text-9">
                      <div className="heading-45">
                      Applicant Name
                      </div>
                      <p className="text-73">
                      <span className="text-73-sub-1"></span><span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="container-13">
                  <div className="checkbox-18">
                    <div className="checkbox-19">
                    </div>
                  </div>
                  <div className="text-info-9">
                    <div className="application-status-9">
                      <div className="heading-46">
                      Application Status
                      </div>
                      <div className="frame-10000043179">
                        <p className="text-75">
                        <span className="text-75-sub-5"></span><span></span>
                        </p>
                        <span className="text-77">
                        Reviewed
                        </span>
                      </div>
                    </div>
                    <div className="recent-experience-9">
                      <div className="heading-48">
                      Recent Experience
                      </div>
                      <div className="frame-100000431818">
                        <span className="text-76">
                        Job title
                        </span>
                        <span className="text-78">
                        8/2017-Present
                        </span>
                      </div>
                    </div>
                    <div className="languages-spoken-9">
                      <div className="heading-47">
                      Language Spoken
                      </div>
                      <div className="frame-100000431819">
                        <span className="text-79">
                        Primary: English
                        </span>
            ...
            <div className="dropdown-buttons-1">
              ...
              <div className="dropdown-menu">
                ...
                <div className="nav-link-1">
                  <div className="checkbox-21">
                    <img className="vector-22" src="assets/vectors/Unknown" />
                  </div>
                  <div className="label-helper-text-1">
                    <span className="write-label-text-here-1">
                    Reviewed
                    </span>
                  </div>
                </div>
                <div className="nav-link-3">
                  <div className="checkbox-23">
                  </div>
                  <div className="label-helper-text-3">
                    <span className="write-label-text-here-3">
                    Contacted
                    </span>
                  </div>
                </div>
                <div className="nav-link-2">
                  <div className="checkbox-22">
                  </div>
                  <div className="label-helper-text-2">
                    <span className="write-label-text-here-2">
                    Accepted
                    </span>
                  </div>
                </div>
