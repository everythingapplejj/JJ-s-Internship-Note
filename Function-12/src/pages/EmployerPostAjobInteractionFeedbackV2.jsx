import './EmployerPostAjobInteractionFeedbackV2.css'

export default function EmployerPostAjobInteractionFeedbackV2() {
  return (
    <div className="employer-post-ajob-interaction-feedback-v-2">
