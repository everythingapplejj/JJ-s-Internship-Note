import './DiffVersion116.css'

export default function DiffVersion116() {
  return (
      ...
      <div className="container-203">
        ...
        <div className="container-34">
          ...
          <div className="container-228">
            ...
            <div className="container-196">
              ...
              <img className="container-107" src="assets/vectors/Unknown" />
            </div>
          </div>
        ...
        <div className="container-146">
          ...
          <div className="container-130">
            <span className="small-business-name">
            Small Business name
            </span>
          </div>
        </div>
        <div className="container-32">
          <div className="rectangle-444">
          </div>
          <div className="frame-427318920">
            <div className="container-198">
              <div className="container-122">
                <div className="ellipse-695">
                </div>
                <div className="company-name-job-title-11">
                Company Name<br />
                Job Title
                </div>
              </div>
        ...
        <div className="container-77">
          <div className="container-93">
            ...
            <span className="retail-associate">
            Retail Associate
            </span>
          </div>
          <div className="rectangle-445">
          </div>
          <div className="frame-427318921">
            <div className="ellipse-696">
            </div>
            <div className="company-name-job-title-2">
            Company Name<br />
            Job Title
            </div>
          ...
          <div className="container-143">
            <div className="text">
              ...
              Google ATAP — the company’s skunkworks division tasked with creating cool new things we’ll all actually use — teased their session with talk of a new wearable that would “literally” blow our socks off.
              </span>
            </div>
        ...
        <div className="container-41">
          <div className="frame-427318922">
            <div className="ellipse-697">
            </div>
            <div className="company-name-job-title">
            Company Name<br />
            Job Title
            </div>
        ...
        <div className="container-207">
          <div className="rectangle-446">
          </div>
          <div className="frame-427318926">
            <div className="ellipse-6981">
            </div>
            <div className="company-name-job-title-1">
            Company Name<br />
            Job Title
            </div>
        ...
        <div className="container-138">
          <div className="rectangle-447">
          </div>
          <div className="frame-427318927">
            <div className="ellipse-6991">
            </div>
            <div className="company-name-job-title-3">
            Company Name<br />
            Job Title
            </div>
        ...
        <div className="container-223">
          <div className="rectangle-448">
          </div>
          <div className="frame-427318930">
            <div className="ellipse-7001">
            </div>
            <div className="company-name-job-title-6">
            Company Name<br />
            Job Title
            </div>
        ...
        <div className="container-213">
          <div className="rectangle-449">
          </div>
          <div className="frame-427318928">
            <div className="ellipse-7011">
            </div>
            <div className="company-name-job-title-4">
            Company Name<br />
            Job Title
            </div>
        ...
        <div className="container-47">
          <div className="rectangle-450">
          </div>
          <div className="frame-427318929">
            <div className="ellipse-7021">
            </div>
            <div className="company-name-job-title-5">
            Company Name<br />
            Job Title
            </div>
        ...
        <div className="container-211">
          <div className="rectangle-451">
          </div>
          <div className="frame-427318931">
            <div className="ellipse-7031">
            </div>
            <div className="company-name-job-title-7">
            Company Name<br />
            Job Title
            </div>
        ...
        <div className="container-214">
          <div className="rectangle-452">
          </div>
          <div className="frame-427318934">
            <div className="ellipse-7041">
            </div>
            <div className="company-name-job-title-9">
            Company Name<br />
            Job Title
            </div>
        ...
        <div className="container-31">
          <div className="rectangle-453">
          </div>
          <div className="frame-427318935">
            <div className="ellipse-7051">
            </div>
            <div className="company-name-job-title-10">
            Company Name<br />
            Job Title
            </div>
        ...
        <div className="container-76">
          <div className="rectangle-454">
          </div>
          <div className="frame-427318932">
            <div className="ellipse-7061">
            </div>
            <div className="company-name-job-title-8">
            Company Name<br />
            Job Title
            </div>
        ...
        <div className="container-164">
          <div className="container-147">
            ...
            <div className="rectangle-437">
            </div>
            <div className="rectangle-439">
            </div>
          </div>
          <div className="container-110">
            <div className="rectangle-424">
            </div>
            <div className="rectangle-438">
            </div>
            <div className="rectangle-440">
            </div>
          </div>
        </div>
          ...
          <div className="container-11">
            ...
            <div className="container-174">
              ...
              <div className="container-141">
                <div className="rectangle-431">
                </div>
              </div>
              <div className="container-10">
                <div className="rectangle-432">
                </div>
              </div>
            </div>
          </div>
