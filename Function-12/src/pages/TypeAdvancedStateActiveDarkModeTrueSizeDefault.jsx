import './TypeAdvancedStateActiveDarkModeTrueSizeDefault.css'

export default function TypeAdvancedStateActiveDarkModeTrueSizeDefault() {
  return (
    <div className="type-advanced-state-active-dark-mode-true-size-default">
      <div className="input">
        <div className="search-outline">
          <img className="vector" src="assets/vectors/Unknown" />
        </div>
        <p className="quick-search-for-anything">
        <span className="quick-search-for-anything-sub-7"></span><span></span>
        </p>
      </div>
        ...
        <div className="nav-links">
          ...
          <div className="nav-link-3">
            <div className="container">
              <div className="wand-magic-sparkles">
