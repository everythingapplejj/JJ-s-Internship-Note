import './ApplicantsPageApplicationStatusFilterActiveLong.css'

export default function ApplicantsPageApplicationStatusFilterActiveLong() {
  return (
    <div className="applicants-page-application-status-filter-active-long">
