import './TypeCtaBreakpointsTabletDarkModeTrue.css'

export default function TypeCtaBreakpointsTabletDarkModeTrue() {
  return (
    <div className="type-cta-breakpoints-tablet-dark-mode-true">
      <div className="bar">
